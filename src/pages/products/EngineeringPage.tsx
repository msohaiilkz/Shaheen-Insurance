  ...
  return (
    <>
      <PageSEO
        ...
        description="Shaheen Insurance engineering insurance — CAR, EAR, CPM, Machinery Breakdown, MLOP, and EEI policies for construction projects and industrial operations in Pakistan."
        keywords="engineering insurance Pakistan, CAR insurance, contractors all risk, machinery breakdown insurance, EEI Pakistan"
      ...
      <PageHero title="Engineering Insurance" subtitle="Comprehensive coverage for construction projects, machinery, and industrial operations — CAR, EAR, CPM, Machinery & MLOP"
        breadcrumbs={[{ label: 'Products', path: '/products' }, { label: 'Engineering' }]} badge="Business Product" videoCategory="engineering" />
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.05 }}
              ...
              <div className="col-span-2 relative rounded-2xl overflow-hidden">
                <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80&auto=format&fit=crop"
                  alt="Engineering Insurance" className="w-full h-full object-cover" loading="lazy" />
                <div className="absolute inset-0 bg-gradient-to-t from-navy/80 via-navy/20 to-transparent" />
                <div className="absolute bottom-4 left-4 flex gap-2 flex-wrap">
                  <span className="bg-gold text-navy font-bold text-xs px-3 py-1 rounded-full">CAR / EAR</span>
                  <span className="bg-white/20 backdrop-blur-sm text-white font-semibold text-xs px-3 py-1 rounded-full">CPM / MLOP</span>
                </div>
              </div>
              <div className="flex flex-col gap-3">
                <div className="relative rounded-2xl overflow-hidden flex-1">
                  <img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=400&q=80&auto=format&fit=crop"
