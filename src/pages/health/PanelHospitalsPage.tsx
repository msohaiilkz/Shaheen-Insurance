  ...
  return (
    <>
      ...
      <InnerPageHero
        ...
        subtitle="Nationwide network of panel hospitals offering cashless treatment, discounts, and quality healthcare for Shaheen Insurance policyholders"
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <ScrollReveal>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">Shaheen Insurance maintains two comprehensive panel hospital networks giving policyholders access to quality healthcare facilities across Pakistan. Panel policyholders benefit from direct billing arrangements and preferential rates — eliminating upfront payments.</p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 lg:px-10">
          <ScrollReveal>
            <div className="text-center mb-14">
              <p className="text-gold text-xs font-bold tracking-[0.25em] uppercase mb-3">Network Details</p>
              <h2 className="font-display font-black text-white text-4xl md:text-5xl uppercase leading-tight tracking-tight">Hospital Networks</h2>
            </div>
          </ScrollReveal>
          <StaggerReveal className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {NETWORKS.map(({ name, desc, features }) => (
              <div key={name} className="p-6 bg-white/6 border border-white/10 rounded-2xl hover:border-gold/30 transition-all">
          ...
          <ScrollReveal>
            <div className="text-center mb-8">
              ...
              <h3 className="font-display font-black text-white text-3xl uppercase">Cities Covered</h3>
            </div>
          </ScrollReveal>
          <StaggerReveal className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-3">
            {CITIES.map((city) => (
              <div key={city} className="flex items-center gap-1.5 p-3 bg-white/6 border border-white/10 rounded-xl hover:border-gold/30 transition-all justify-center">
                <MapPin size={11} className="text-gold shrink-0" />
                <span className="text-white/70 text-xs font-medium">{city}</span>
              </div>
            ))}
          </StaggerReveal>
        </div>
      ...
      <section className="py-20 bg-navy relative overflow-hidden">
        ...
        <ScrollReveal>
          <div className="relative z-10 max-w-3xl mx-auto px-5 text-center">
            <p className="text-gold text-xs font-bold tracking-[0.25em] uppercase mb-4">Contact Health Dept</p>
            ...
            <p className="text-white/50 mb-8 max-w-lg mx-auto text-sm leading-relaxed">For queries about panel coverage, pre-authorization, or to request the latest hospital lists — contact our Health Department directly.</p>
